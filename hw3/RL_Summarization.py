...
from RL_Trainer import RLSeq2SeqTrainer
...
def main():
    ...
    if data_args.text_column is None:
        raise Exception("Please provide --text_column")
    else:
    ...
    if data_args.summary_column is None:
        raise Exception("Please provide --summary_column")
    else:
